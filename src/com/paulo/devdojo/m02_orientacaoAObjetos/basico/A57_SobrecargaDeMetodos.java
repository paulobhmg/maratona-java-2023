...
public class A57_SobrecargaDeMetodos {
    public static void main(String[] args) {
        System.out.println("Novo cálculo: " + Calculadora.novoCalculo(10, 20));
        System.out.println("Novo cálculo 1: " + Calculadora.novoCalculo(10, 20, '+'));
        System.out.println("Novo cálculo 2: " + Calculadora.novoCalculo(10, 20, '-'));
        System.out.println("Novo cálculo 3: " + Calculadora.novoCalculo(10, 20, '*'));
        System.out.println("Novo cálculo 4: " + Calculadora.novoCalculo(10, 20, '/'));
        System.out.println("Novo cálculo 5: " + Calculadora.novoCalculo(10, 20, '1'));
    }
}
